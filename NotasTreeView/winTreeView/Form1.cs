    ...
    public partial class Form1 : Form
    {
        ...
        private void guardaNodosXML()
        {
            try
            {
                ...
                if (tvNodos != null)
                {
                    ...
                    {
                        sw = new StreamWriter("nodos.xml", false, System.Text.Encoding.UTF8);
            ...
            {
                MessageBox.Show(ex.Source + "\n" + ex.Message, "Error en guardaNodosXML", MessageBoxButtons.OK, MessageBoxIcon.Error);
                sw.Close();
            }
        ...
        private void btnNodo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtNodo.Text == "")
                {
                    stlMensaje.Text = "Debe teclear un Nodo";
        ...
        private void btnEliminarElem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Debe seleccionar el elemento que desea eliminar", "Error de selección", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    stlMensaje.Text = "Debe seleccionar el elemento que desea eliminar";
                    lstElementos.Focus();
                    return;
                }
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Error en Form1_FormClosing", MessageBoxButtons.OK, MessageBoxIcon.Error);
                stlMensaje.Text = ex.Message;
            }
        }
